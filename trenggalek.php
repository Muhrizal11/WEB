...
<link rel="icon" href="images/headicon.png" type="image" sizes="15x15">
  ...
  <body>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
        <center>
      <img src="images/Trenggalek.png" height="200px" width="250px"  alt="">
      </center>
        <div class="row">
          <div class="col-md-11 ftco-animate">
            <h2 class="mb-10 text-center" >Sekilas Tentang Trenggalek</h2>
                    <p style="text-align: justify;">Kabupaten  Trenggalek  dengan  luas  wilayah  126.140  Ha,  dimana  2/3  bagian luasnya  merupakan  tanah pegunungan,  terbagi  menjadi  14  Kecamatan  dan  157  Desa. Sedangkan luas laut 4 mil dari daratan adalah 711,17   km. Jumlah penduduk tahun 2014    sebanyak 818.797 jiwa  terdiri  dari 50,34 % laki-laki dan 49.66 % wanita, dengan kepadatan penduduk 649jiwa/km2.
                    <br>
                    <br>
                    Jumlah  rumah  sakit  4,  puskesmas  22,  puskesmas  pembantu  66,  dan  jumlah tenaga medis diantaranya dokter umum 99,  spesialis 28,  D -III  perawat 475,  D -III  bidan 216, serta apoteker 69   orang. Dari sisi pendidikan tercatat jumlah fasilitas pendidikan SD, SLTP, SLTA masingâ€“masing sejumlah 442,78, dan 45 buah.
                    <br>
                    <br>
